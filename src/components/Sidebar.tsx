...
function Sidebar(){
    ...
    useEffect(() => {
        setProfile(Number(localStorage.getItem("profile") || "0") as Profile);
    }, [])
    ...
    return(
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
            ...
            <a className="navbar-brand m-0" href=" https://www.bnb.gov.br/ " target="_blank">
                <img src="/logo192.png" className="navbar-brand-img h-100" alt="main_logo" />
                <span className="ms-1 font-weight-bold text-white">Banco Comunidade V1</span>
            </a>
            </div>
